...
* Date: 12/07/17
* */
package com.example.arunm.cseelection2017;
...
//calculating winners........
        ...
        if (tempp1 == tempp2) {
            ...
            dummy = tempp1 - tempp2;
            tv_presidentwincount.setText(getString(R.string.Winsby) + String.valueOf(dummy));
            president.setImageResource(R.drawable.arvind);
        } else {

            tv_presidentname.setText(getString(R.string.Winner) + getString(R.string.presidentname2cv));
            dummy = tempp2 - tempp1;
            tv_presidentwincount.setText(getString(R.string.Winsby) + String.valueOf(dummy));
            president.setImageResource(R.drawable.yogi);
        }
...
//vice president
        ...
        if (tempvp1 == tempvp2) {
            ...
            vicepresident.setImageResource(R.drawable.ganapathy);
            ...
            vicepresident.setImageResource(R.drawable.surya);
        ...
        if (temps1 == temps2) {
            ...
            dummy = temps1 - temps2;
            tv_secretarywincount.setText(getString(R.string.Winsby) + String.valueOf(dummy));
            secretary.setImageResource(R.drawable.jeeva);
            ...
            dummy = temps2 - temps1;
            tv_secretarywincount.setText(getString(R.string.Winsby) + String.valueOf(dummy));
            secretary.setImageResource(R.drawable.nive);
        ...
        if (tempjs1 == tempjs2) {
            ...
            tv_jointsecretarywincount.setText(getString(R.string.Winsby) + String.valueOf(dummy));
            jointsecretary.setImageResource(R.drawable.malavika);

        } else {
            tv_jointsecretaryname.setText(getString(R.string.Winner) + getString(R.string.joint_secretary_name2cv));
            dummy = tempjs2 - tempjs1;
            tv_jointsecretarywincount.setText(getString(R.string.Winsby) + String.valueOf(dummy));
           jointsecretary.setImageResource(R.drawable.sowndharya);
